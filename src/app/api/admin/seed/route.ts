...
export async function POST() {
  try {
    ...
    await prisma.sandwich.createMany({
      data: [
        { name: "El Crudo", description: "El clásico italiano, pero con onda mendocina", ingredients: ["Jamón crudo", "Queso sardo", "Tomate", "Rúcula", "Pesto de albahaca"], price: 3500, available: true, displayOrder: 1 },
        { name: "La Mortadela", description: "La reina de la charcutería, versión premium", ingredients: ["Mortadela con pistacho", "Stracciatella", "Queso sbrinz", "Pesto de albahaca"], price: 3800, available: true, displayOrder: 2 },
        { name: "La Patrona", description: "Para los que mandan en la mesa, sin carne pero con carácter", ingredients: ["Milanesa de berenjena", "Queso sardo", "Cebolla pickle", "Tomate", "Rúcula", "Alioli alimonado"], price: 3200, available: true, displayOrder: 3 },
      ],
      skipDuplicates: true,
    })
    ...
    await prisma.adminUser.upsert({
      ...
      update: {},
      create: { username: "guchini-admin", passwordHash: hash },
    })
